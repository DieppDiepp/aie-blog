...
date: "2026-08-30"
thumbnail: "https://media.aiengineerblog.com/posts/object-storage-minio-vs-cloudflare-r2/cover.svg?v=2"
tags:
  - label: "Hệ thống"
    variant: "topic"
...
```text
https://media.aiengineerblog.com/posts/object-storage-minio-vs-cloudflare-r2/serve-path.svg?v=1
```
...
![High-level view: a blog's content splits in two. Article text lives in a Git repository where it is versioned. Images live in object storage and are served to readers by URL. This article is about the images half.](https://media.aiengineerblog.com/posts/object-storage-minio-vs-cloudflare-r2/overview.svg?v=1)
