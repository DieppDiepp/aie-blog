...
summary: "Dựng pipeline để mỗi lần push code là website trên VPS tự cập nhật: CI kiểm tra, build image đẩy lên GHCR, rồi deploy qua SSH mà không gõ tay."
date: "2026-08-25"
tags:
  - label: "Hệ thống"
    variant: "topic"
  - label: "Trung bình"
    variant: "mid"
# thumbnail: "/images/posts/ci-cd-deploy-vps-github-actions.jpg"
---
...
- Khi mua domain: đổi từ quick tunnel sang named tunnel gắn domain để có URL ổn định
  ...
  ở bài domain-dns-tls-cho-nguoi-moi (nên nối với bài này trong đồ thị tri thức sau này).
